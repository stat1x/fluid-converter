	...
	_createClass(Application, [{
		...
		value: function initializeConvertForm() {
			...
			this.conversionForm.submit(function (event) {
				...
				_this2.conversionResult.html(_this2.convertFluidTags($('#fluid-node-to-convert').val())).removeClass('hide');
			});
		}
	}, {
...
},{"../Vendors/simple-html-tokenizer/lib/simple-html-tokenizer/index":7,"./AbstractApplication":1}],3:[function(require,module,exports){
"use strict";
...
},{"./entity-parser":4,"./evented-tokenizer":5,"./html5-named-char-refs":6,"./tokenize":8,"./tokenizer":9}],8:[function(require,module,exports){
'use strict';
...
},{"./entity-parser":4,"./html5-named-char-refs":6,"./tokenizer":9}],9:[function(require,module,exports){
'use strict';
...
},{"./evented-tokenizer":5}],10:[function(require,module,exports){
"use strict";
